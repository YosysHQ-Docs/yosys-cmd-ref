...
.. only:: html
    ...
    :code:`extract -map <map_file> [options] [selection]`

    :code:`extract -mine <out_file> [options] [selection]` ::
    ...
    :code:`-compat <needle_type> <haystack_type>` ::
